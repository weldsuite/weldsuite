 ...
 * already runs on app-api via object-based mounts (`/api/workflows`,
 * `/api/workflow-executions`, and sibling `/api/workflow-*` routes). The dead
 * client was removed rather than repointed.
 *
