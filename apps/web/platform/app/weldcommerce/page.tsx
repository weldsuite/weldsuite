...
function useCounts() {
  ...
  const customers = useCompanies({ limit: 1 });
  ...
  return {
    ...
    customers: customers.data?.pagination?.totalCount,
    isLoading:
      products.isLoading || categories.isLoading || orders.isLoading || customers.isLoading,
  };
}
