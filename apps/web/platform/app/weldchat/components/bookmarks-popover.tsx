...
/**
 * Saved-messages popover. Mirrors the one in the weldchat channel header.
 * Shared so the project chat header (and anywhere else that wants saved
 * items) behaves identically.
 */
export function BookmarksPopover({ onClose }: { onClose?: () => void } = {}) {
  const { t } = useI18n();
  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto max-h-[calc(70vh-48px)] relative">
