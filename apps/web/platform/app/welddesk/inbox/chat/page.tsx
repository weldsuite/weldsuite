...
export default function ChatInboxPage() {
  ...
  return (
    <div className="h-full flex-1 hidden md:flex flex-col items-center justify-center text-center px-6 bg-white dark:bg-background/30">
      ...
      <h3 className="text-[15px] font-semibold text-foreground mb-1.5">{ip.noChatSelectedTitle}</h3>
      <p className="text-sm text-muted-foreground max-w-[320px] leading-relaxed">{ip.noChatSelectedDesc}</p>
    </div>
  );
}
