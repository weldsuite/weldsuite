      ...
      {step === 'select' ? (
        <DialogContent className="sm:max-w-xl overflow-hidden p-0 gap-0" showCloseButton={false}>
          <DialogHeader className="sr-only">
            <DialogTitle>{ti.selectTicketType}</DialogTitle>
            <DialogDescription>{ti.searchAndSelectTicketType}</DialogDescription>
          </DialogHeader>
        ...
        <DialogContent className="sm:max-w-3xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{ti.createSupportTicket}</DialogTitle>
          </DialogHeader>
          <DynamicTicketForm
