import { ArrowRightLeft, UserPlus, AlertTriangle, Flag, Settings, ChevronDown, ChevronUp, Plus, Trash2, Archive } from 'lucide-react';
        ...
        return (
          <div key={log.id} className="flex">
            ...
            <div style={{ width: 20, flexShrink: 0, position: 'relative' }}>
              {/* Icon */}
              <div
                className={cn('relative z-10 flex items-center justify-center rounded-[6px]', colors.bg, colors.icon)}
              ...
              {!isLast && (
                <div
                  style={{ position: 'absolute', left: 9, top: 24, bottom: 0, width: 1, backgroundColor: 'var(--color-border)' }}
                />
              )}
            </div>
