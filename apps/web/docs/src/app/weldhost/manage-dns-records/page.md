...
nextjs:
  metadata:
    title: Add DNS records
    description: A step-by-step guide to adding DNS records for your website and email in WeldHost.
---

Add, edit, and delete DNS records for a domain that is already connected in WeldHost. {% .lead %}
...
{% figure src="/images/help/dns-add-record.png" alt="Add a new DNS record form" caption="Fill in the type, name, and value your service provider gave you, then save." /%}
...
{% figure src="/images/help/dns-record-types.png" alt="DNS record type selector" caption="Choose the record type that matches what your provider asked for." /%}
...
{% figure src="/images/help/dns-locked.png" alt="Locked DNS record with lock badge" caption="Locked records are managed automatically — use the relevant app settings instead." /%}
