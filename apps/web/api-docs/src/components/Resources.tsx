...
const resources: Array<Resource> = [
  {
    ...
    name: 'Companies',
    description:
      'Manage CRM company records — retrieve, create, update, and delete companies in your workspace.',
    icon: UsersIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  },
  {
    ...
    name: 'Projects',
    description:
      'Access WeldFlow project data, including tasks, members, sprints, milestones, and more.',
    icon: ClipboardIcon,
    pattern: {
      y: -6,
      squares: [
  ...
  },
  {
    ...
    name: 'Channels',
    description:
      'Read and manage WeldChat channels, members, messages, drafts, bookmarks, and sections.',
    icon: ChatBubbleIcon,
    pattern: {
      y: 32,
      squares: [
  ...
  },
  {
    ...
    name: 'Calendars',
    description:
      'Create and query WeldCalendar calendars and events, including recurring event support.',
    icon: CalendarIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
  ...
  },
  {
    ...
    name: 'Files',
    description:
      'Manage WeldDrive file metadata — list, update, soft-delete, and organise files into folders.',
    icon: FolderIcon,
    pattern: {
      y: 10,
      squares: [
