...
import { CalendarDays, CreditCard, Link2, LogOut } from 'lucide-react';
...
export function AppShell() {
  const { has } = useAuth();
  const isPro = Boolean(has?.({ plan: 'weldcalendar_pro' }));
      ...
      <div className="flex h-full gap-0 overflow-hidden">
        <aside className="flex w-[200px] shrink-0 flex-col px-2 py-3">
          ...
          <nav className="flex flex-1 flex-col gap-0.5">
            ...
            <NavLink to="/scheduling" className={navLinkClass}>
