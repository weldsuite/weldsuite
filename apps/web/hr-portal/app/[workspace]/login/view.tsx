...
export default function LoginView() {
  ...
  function redirectFor(kind: 'employee' | 'client') {
    // A different person may have used this tab before; never show their cached pages.
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 bg-gray-50" style={brandingStyle(config)}>
