            ...
            <div>
              <p className="text-sm text-gray-500">
                {data.clock.clockedIn && data.clock.since
                  ? format(dict.home.clockedInSince, { time: formatTime(data.clock.since, locale, timeZone) })
          ...
          {!data.latestEvaluation ? (
            ...
            <div className="text-sm space-y-1">
              ...
              <p className="text-gray-500">
                {data.latestEvaluation.overallScore ?? dict.common.none} · {formatDate(data.latestEvaluation.submittedAt, locale, timeZone)}
              </p>
            </div>
          )}
        </Card>
