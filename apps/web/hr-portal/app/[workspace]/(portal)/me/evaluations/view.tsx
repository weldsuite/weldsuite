              ...
              <div className="flex flex-wrap items-start justify-between gap-2">
                <div>
                  ...
                  {ev.periodStart && ev.periodEnd && (
                    <p className="text-sm text-gray-500">{format(dict.performance.period, { start: formatDate(ev.periodStart, locale, timeZone), end: formatDate(ev.periodEnd, locale, timeZone) })}</p>
                  )}
                  {ev.evaluatorName && (
