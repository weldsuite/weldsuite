 ...
 * reply via the Cloudflare AI Gateway; now short-circuits and escalates to
 * a human agent the same way the pre-existing "insufficient credits" path
 * already did, so callers (the workflow engine) see the same
