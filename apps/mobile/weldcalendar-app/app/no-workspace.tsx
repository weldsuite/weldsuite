    ...
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      <View style={styles.content}>
        <View style={[styles.iconCircle, { backgroundColor: colors.cardBackground }]}>
          <Inbox size={48} color="#FE466C" />
        </View>

        <Text style={[styles.title, { color: colors.text }]}>Couldn’t open your calendar</Text>

        <Text style={[styles.description, { color: colors.muted }]}>
          WeldCalendar couldn’t set up a personal calendar for{' '}
          <Text style={{ fontWeight: '600' }}>{user?.email}</Text>. Check your connection and tap
          refresh, or ask a workspace admin to invite you.
        </Text>
