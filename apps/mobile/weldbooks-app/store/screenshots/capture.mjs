/**
 * Capture WeldBooks store screenshots from scenes.html.
 *
 *   node apps/mobile/weldbooks-app/store/screenshots/capture.mjs
 *
...
const SCENES = [
  ...
  ['04-invoice-detail', 'invoice'],
  ['05-scan', 'scan'],
  ['06-expenses', 'expenses'],
];

// Logical CSS pixels × scale = store pixel size.
// Rendering at 1290 CSS-px made 34px titles look tiny; phones are ~390–430pt.
const SIZES = {
  // iPhone 12/13 Pro Max — the 6.7" size App Store Connect accepts
  // (1242×2688 / 1284×2778). 1290×2796 is a newer 6.7" and gets rejected
  // in some listing slots.
  'ios-6.7': {
    width: 428,
    height: 926,
  ...
  // Same logical size as iPhone so type matches; 3× on 360×640 was too tight.
  'android-phone': {
    width: 430,
    height: 932,
