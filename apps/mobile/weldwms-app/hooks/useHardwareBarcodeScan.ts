 ...
 * intent (`com.weldsuite.weldwms.SCAN`). USB / keyboard-wedge scanners still
 * type into the focused search field and submit with Enter — that path is
 * handled by the search bar, not this hook.
 */
