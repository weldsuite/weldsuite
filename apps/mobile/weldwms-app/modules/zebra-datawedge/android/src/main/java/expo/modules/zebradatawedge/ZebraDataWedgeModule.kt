 ...
 * while WeldWMS is in the foreground, the receiver:
...
class ZebraDataWedgeModule : Module() {
  ...
  private fun registerScanReceiver() {
    ...
    val senderPermission = signatureBroadcastPermission(context)
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
      ...
      context.registerReceiver(scanReceiver, filter, senderPermission, null)
    }
