...
import { INTL_LOCALES, type AppLanguage, resolveAppLanguage } from './language';
...
interface I18nContextValue {
  ...
  plural: (count: number, forms: { one: string; other: string }, values?: Record<string, unknown>) => string;
}
