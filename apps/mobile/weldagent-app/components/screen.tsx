/**
 * Screen chrome shared by every WeldAgent route.
 *
 * Tab screens use a large messaging-app title and an optional pill of icon
 * actions — the same chrome as the floating bottom nav.
 */
  ...
  return (
    <View style={[styles.header, style]}>
      <View style={[styles.headerRow, large && styles.headerRowLarge]}>
        ...
        {actions ? (
          <View style={[styles.actionGroup, { backgroundColor: colors.secondary }]}>{actions}</View>
        ) : null}
      </View>
