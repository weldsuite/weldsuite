...
import { isZebraScannerAvailable } from '@/modules/zebra-datawedge';
...
export default function SettingsScreen() {
  ...
  const zebraReady = isZebraScannerAvailable();
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: colors.card }]}>
        <Text style={[styles.sectionTitle, { color: colors.muted }]}>Scanner</Text>
        <View style={styles.row}>
          <Text style={[styles.label, { color: colors.text }]}>Zebra DataWedge</Text>
          <Text style={[styles.value, { color: colors.muted }]}>{zebraReady ? 'Connected' : 'Not on this device'}</Text>
        </View>
      </View>
