    ...
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      <View style={styles.content}>
        ...
        <Text style={[styles.description, { color: colors.muted }]}>
          To get started with WeldStash, create your workspace on our website. Once your workspace is ready, come back here to sign in.
        </Text>
        ...
        >
          ...
          <Text style={[styles.secondaryButtonText, { color: '#EA580C' }]}>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#EA580C', borderRadius: 12, paddingVertical: 14, paddingHorizontal: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, width: '100%' },
