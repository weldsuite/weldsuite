          ...
          ListEmptyComponent={
            !loading ? (
              <View style={styles.empty}>
                <Bookmark size={48} color={colors.muted} strokeWidth={1.5} />
...
const makeStyles = (c: ThemeColors, topInset: number, bottomInset: number) =>
  StyleSheet.create({
    ...
    itemBody: { flex: 1 },
    itemChannel: { fontSize: 12, color: BRAND, fontWeight: '600', marginBottom: 1 },
    itemAuthor: { fontSize: 13, fontWeight: '600', color: c.text, marginBottom: 2 },
    itemContent: { fontSize: 14, color: c.mutedForeground, lineHeight: 19 },
    itemNote: { fontSize: 12, color: c.muted, fontStyle: 'italic', marginTop: 4 },
