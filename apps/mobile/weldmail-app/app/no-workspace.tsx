...
const WELDSUITE_URL = 'https://app.weldsuite.org';
    ...
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      <View style={styles.content}>
        ...
        <Text style={[styles.description, { color: colors.muted }]}>
          To get started with WeldMail, create your workspace on our website. Once your workspace is ready, come back here to sign in.
        </Text>

        <TouchableOpacity style={styles.primaryButton} onPress={handleOpenWebsite}>
          <Globe size={18} color="#fff" />
          <Text style={styles.primaryButtonText}>Go to app.weldsuite.org</Text>
        </TouchableOpacity>
        ...
        >
          {checking ? (
            <MaterialSpinner size={18} strokeWidth={2.4} color="#3B82F6" spinning />
          ) : (
