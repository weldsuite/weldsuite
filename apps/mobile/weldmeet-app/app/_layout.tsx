// MUST be the first import: registers TextDecoder / atob / URL polyfills
// before any @cloudflare/realtimekit module is evaluated.
import '@/polyfills';
              ...
              <AuthGuard>
                <RealtimeProvider>
                  <Stack screenOptions={{ headerShown: false }}>
                    ...
                    <Stack.Screen name="meeting/[id]/index" options={{ presentation: 'card' }} />
                    <Stack.Screen
                      name="meeting/[id]/room"
