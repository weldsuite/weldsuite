...
function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  // app-api token wiring — the client re-reads on every request, so the
  // token stays fresh across Clerk refreshes. The JWT carries the active
  // org, which app-api uses to resolve the tenant DB.
  useEffect(() => {
    if (user) {
              ...
              <AuthGuard>
                <RealtimeProvider>
                  <Stack screenOptions={{ headerShown: false }}>
                    ...
                    <Stack.Screen
                      name="post/[id]"
                      options={{ presentation: 'card', animation: 'slide_from_right', gestureEnabled: true, gestureDirection: 'horizontal', fullScreenGestureEnabled: true }}
                    />
                    <Stack.Screen name="analytics" options={{ animation: 'slide_from_right', gestureEnabled: true, gestureDirection: 'horizontal', fullScreenGestureEnabled: true }} />
                    <Stack.Screen name="accounts" options={{ animation: 'slide_from_right', gestureEnabled: true, gestureDirection: 'horizontal', fullScreenGestureEnabled: true }} />
                    <Stack.Screen name="campaigns" options={{ animation: 'slide_from_right', gestureEnabled: true, gestureDirection: 'horizontal', fullScreenGestureEnabled: true }} />
                    <Stack.Screen name="settings" options={{ animation: 'slide_from_right', gestureEnabled: true, gestureDirection: 'horizontal', fullScreenGestureEnabled: true }} />
                  </Stack>
                </RealtimeProvider>
              </AuthGuard>
