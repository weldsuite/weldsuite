    ...
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      <View style={styles.content}>
        ...
        <Text style={[styles.description, { color: colors.muted }]}>
          To get started with WeldSocial, create your workspace on our website. Once your workspace is ready, come back here to sign in.
        </Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#8B5CF6', borderRadius: 12, paddingVertical: 14, paddingHorizontal: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, width: '100%' },
