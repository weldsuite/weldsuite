...
export const KanbanBoard = ({ id, children, className }: KanbanBoardProps) => {
  ...
  return (
    <div
      className={cn(
        'group/board flex min-h-40 flex-col text-xs transition-all rounded-lg',
  ...
  return (
    <>
      <div style={style} {...listeners} {...attributes} ref={setNodeRef}>
        <Card
          className={cn(
            'cursor-grab gap-4 rounded-lg p-3',
...
>({
  ...
  const customCollisionDetection: CollisionDetection = (args) => {
    ...
    // Filter to only include column droppables (not card sortables)
    ...
    // If pointer is within any droppable, use that
    ...
    <KanbanContext.Provider value={{ columns, data, activeCardId }}>
      ...
      >
        <div
          ...
          style={{ gridAutoColumns: '280px', gap: '0px' }}
        >
