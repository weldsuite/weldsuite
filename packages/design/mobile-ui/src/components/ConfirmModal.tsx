            ...
            <View style={[styles.modal, { backgroundColor: colors.background }]}>
              ...
              <View style={styles.buttons}>
                <TouchableOpacity
                  ...
                  onPress={onCancel} disabled={loading} activeOpacity={0.7}
                >
...
const styles = StyleSheet.create({
  ...
  modal: { width: '100%', maxWidth: 340, borderRadius: 16, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 12, elevation: 8 },
  ...
  button: { flex: 1, paddingVertical: 12, borderRadius: 10, alignItems: 'center', justifyContent: 'center', minHeight: 44 },
