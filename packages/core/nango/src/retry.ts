...
export function isRetryable(error: unknown): boolean {
  if (error instanceof NangoApiError) return error.retryable;
...
export function backoffDelayMs(
  ...
  if (error instanceof NangoApiError && error.retryAfterSeconds !== undefined) {
