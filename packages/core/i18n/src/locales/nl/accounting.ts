export const accounting = {
    ...
    bankingPages: {
      ...
      categorizeTitle: 'Geen factuur?',
      categorizeHint: 'Voor geld dat geen klantbetaling is — terugbetaalde transactiekosten, settlements, rente — boek naar een grootboekrekening. Maak geen factuur aan PayPal of je bank.',
      categorizeAccountLabel: 'Boeken op rekening',
      categorizeAccountPlaceholder: 'Selecteer rekening',
      categorizeButton: 'Categoriseren',
      categorizeExamples: 'Typische rekeningen: Overige opbrengsten (settlements), Bankkosten (terugbetaalde fees), Privé (eigen stortingen).',
