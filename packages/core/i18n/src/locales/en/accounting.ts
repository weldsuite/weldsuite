export const accounting = {
    ...
    bankingPages: {
      ...
      categorizeTitle: 'Not an invoice?',
      categorizeHint: 'For money that is not a customer payment — fee refunds, processor settlements, interest — pick a ledger account. Do not create an invoice to PayPal or your bank.',
      categorizeAccountLabel: 'Post to account',
      categorizeAccountPlaceholder: 'Select account',
      categorizeButton: 'Categorize',
      categorizeExamples: 'Typical accounts: Other income (settlements), Bank fees (processor refunds), Equity (owner deposits).',
