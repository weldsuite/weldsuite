export const developer = {
  ...
  create: {
    ...
    logoLabel: 'App logo',
    logoHint: 'PNG, JPEG, WebP, or SVG — max 2 MB. Shown in the app store and sidenav.',
    logoUpload: 'Upload logo',
    logoReplace: 'Replace logo',
    logoRemove: 'Remove',
    logoTypeError: 'Use a PNG, JPEG, WebP, or SVG image.',
    logoSizeError: 'Logo must be 2 MB or smaller.',
    logoUploadError: 'Failed to upload logo',
    logoAfterCreateHint: 'You can upload an app logo on the next screen after creating the app.',
